...
public class FloatTag extends Tag {
     ...
     *             - in case of IO error
     */
    public FloatTag(String name, VariableInteger id) throws IOException {
        super(name, id);
    }
     ...
     *             - in case of IO error
     */
    public FloatTag(String name, VariableInteger id, VariableInteger size, InputStream inputStream) throws IOException {
    ...
    public FloatTag setValue(double value) {
        this.value = value;
        size = VariableInteger.fromValue(8);
        return this;
    }
