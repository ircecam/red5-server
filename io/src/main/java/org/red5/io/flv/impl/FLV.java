...
public class FLV implements IFLV {
     ...
     * information 0x12 META Contains two ActionMessageFormat packets, the name of the event and the data to go with it soundType (byte & 0x01) == 0 0: mono, 1: stereo soundSize (byte & 0x02) == 1 0:
